...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Contact | MyWardBulletin</title>
        <meta name="description" content="Contact the creator of MyWardBulletin. Have a question or feature request? Reach out directly by email." />
        <meta property="og:title" content="Contact | MyWardBulletin" />
        <meta property="og:description" content="Have a question, bug report, or feature request for MyWardBulletin? Contact the creator directly by email." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://mywardbulletin.com/contact" />
        <meta property="og:image" content="https://mywardbulletin.com/og-image.png" />
        <meta property="og:site_name" content="MyWardBulletin" />
        <meta property="og:image:alt" content="Contact MyWardBulletin support" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Contact | MyWardBulletin" />
        <meta name="twitter:description" content="Reach out directly for help, feedback, or suggestions." />
        ...
        <script type="application/ld+json">{`
          {
            ...
            "@type": "WebPage",
            "name": "Contact",
            "description": "Reach out to the creator of MyWardBulletin with feedback, questions, or support requests.",
            "url": "https://mywardbulletin.com/contact",
            "publisher": {
              "@type": "Person",
              "name": "Matthew Fuller"
            }
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-2xl mx-auto mt-8">
          ...
          <p className="mb-4 text-gray-700">
            I try to respond to all messages within 1–2 days. If it’s urgent (like something broke on Sunday morning), please include <strong>URGENT</strong> in the subject line.
          </p>
